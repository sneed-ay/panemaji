...
export const metadata: Metadata = {
  title: "ヘルスのサービスの流れ｜パネマジ掲示板",
  description: "入店から退店までの基本的な流れ。ヘルスのサービスの流れを徹底解説し、失敗しない選び方を紹介します。",
  keywords: ["ヘルス 流れ","ヘルス 初めて","ファッションヘルス 使い方"],
  alternates: { canonical: "https://panemaji.com/guide/health-service-flow" },
  openGraph: {
    title: "ヘルスのサービスの流れ｜パネマジ掲示板",
    description: "入店から退店までの基本的な流れ",
    type: "article", locale: "ja_JP", siteName: "パネマジ掲示板",
    url: "https://panemaji.com/guide/health-service-flow",
  },
};

export default function Health_service_flowPage() {
  return (
    <ArticleLayout
      title="ヘルスのサービスの流れ"
      subtitle="入店から退店までの基本的な流れ"
      breadcrumb="ヘルスの流れ"
      slug="health-service-flow"
    ...
    >
      <section>
        ...
        <p className="mb-3">
          ヘルスのサービスの流れについて、初めての方にもわかりやすく解説します。このガイドでは入店から退店までの基本的な流れを中心に、必要な情報をまとめています。パネマジ掲示板の口コミと合わせて参考にしてください。
        </p>
      </section>
