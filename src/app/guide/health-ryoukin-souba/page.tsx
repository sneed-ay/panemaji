...
export const metadata: Metadata = {
  title: "ヘルスの料金相場ガイド｜パネマジ掲示板",
  description: "ヘルスの料金システムと相場を解説。ヘルスの料金相場ガイドを徹底解説し、失敗しない選び方を紹介します。",
  keywords: ["ヘルス 料金","ヘルス 相場","ファッションヘルス 価格"],
  alternates: { canonical: "https://panemaji.com/guide/health-ryoukin-souba" },
  openGraph: {
    title: "ヘルスの料金相場ガイド｜パネマジ掲示板",
    description: "ヘルスの料金システムと相場を解説",
    type: "article", locale: "ja_JP", siteName: "パネマジ掲示板",
    url: "https://panemaji.com/guide/health-ryoukin-souba",
  },
};

export default function Health_ryoukin_soubaPage() {
  return (
    <ArticleLayout
      title="ヘルスの料金相場ガイド"
      subtitle="ヘルスの料金システムと相場を解説"
      breadcrumb="ヘルス料金"
      slug="health-ryoukin-souba"
    ...
    >
      <section>
        ...
        <p className="mb-3">
          ヘルスの料金相場について、初めての方にもわかりやすく解説します。このガイドではヘルスの料金システムと相場を解説を中心に、必要な情報をまとめています。パネマジ掲示板の口コミと合わせて参考にしてください。
        </p>
      </section>
