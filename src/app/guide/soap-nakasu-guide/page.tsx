...
export const metadata: Metadata = {
  title: "中洲ソープガイド｜パネマジ掲示板",
  description: "福岡・中洲のソープ街を徹底解説。中洲ソープガイドを徹底解説し、失敗しない選び方を紹介します。",
  keywords: ["中洲 ソープ","福岡 ソープ","中洲 風俗"],
  alternates: { canonical: "https://panemaji.com/guide/soap-nakasu-guide" },
  openGraph: {
    title: "中洲ソープガイド｜パネマジ掲示板",
    description: "福岡・中洲のソープ街を徹底解説",
    type: "article", locale: "ja_JP", siteName: "パネマジ掲示板",
    url: "https://panemaji.com/guide/soap-nakasu-guide",
  },
};

export default function Soap_nakasu_guidePage() {
  return (
    <ArticleLayout
      title="中洲ソープガイド"
      subtitle="福岡・中洲のソープ街を徹底解説"
      breadcrumb="中洲ソープ"
      slug="soap-nakasu-guide"
    ...
    >
      <section>
        ...
        <p className="mb-3">
          中洲ソープについて、初めての方にもわかりやすく解説します。このガイドでは福岡・中洲のソープ街を徹底解説を中心に、必要な情報をまとめています。パネマジ掲示板の口コミと合わせて参考にしてください。
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mb-3">
          中洲ソープは、伝統あるソープランド街として知られています。高級店から大衆店まで幅広く、予算や好みに応じて選べるのが魅力です。
        </p>
      </section>
