...
export const metadata: Metadata = {
  title: "東京のソープ人気店ランキング｜パネマジ掲示板",
  description: "吉原・新大久保など東京のソープ。東京のソープ人気店ランキングを徹底解説し、失敗しない選び方を紹介します。",
  keywords: ["東京 ソープ ランキング","吉原 ソープ"],
  alternates: { canonical: "https://panemaji.com/guide/soap-tokyo-ranking" },
  openGraph: {
    title: "東京のソープ人気店ランキング｜パネマジ掲示板",
    description: "吉原・新大久保など東京のソープ",
    type: "article", locale: "ja_JP", siteName: "パネマジ掲示板",
    url: "https://panemaji.com/guide/soap-tokyo-ranking",
  },
};

export default function Soap_tokyo_rankingPage() {
  return (
    <ArticleLayout
      title="東京のソープ人気店ランキング"
      subtitle="吉原・新大久保など東京のソープ"
      breadcrumb="東京ソープ"
      slug="soap-tokyo-ranking"
    ...
    >
      <section>
        ...
        <p className="mb-3">
          東京のソープ人気店について、初めての方にもわかりやすく解説します。このガイドでは吉原・新大久保など東京のソープを中心に、必要な情報をまとめています。パネマジ掲示板の口コミと合わせて参考にしてください。
        </p>
      </section>
