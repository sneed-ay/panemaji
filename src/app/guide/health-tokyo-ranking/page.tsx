...
export const metadata: Metadata = {
  title: "東京のヘルス人気店ランキング｜パネマジ掲示板",
  description: "東京の人気ヘルス店を厳選。東京のヘルス人気店ランキングを徹底解説し、失敗しない選び方を紹介します。",
  keywords: ["東京 ヘルス ランキング","東京 ファッションヘルス"],
  alternates: { canonical: "https://panemaji.com/guide/health-tokyo-ranking" },
  openGraph: {
    title: "東京のヘルス人気店ランキング｜パネマジ掲示板",
    description: "東京の人気ヘルス店を厳選",
    type: "article", locale: "ja_JP", siteName: "パネマジ掲示板",
    url: "https://panemaji.com/guide/health-tokyo-ranking",
  },
};

export default function Health_tokyo_rankingPage() {
  return (
    <ArticleLayout
      title="東京のヘルス人気店ランキング"
      subtitle="東京の人気ヘルス店を厳選"
      breadcrumb="東京ヘルス"
      slug="health-tokyo-ranking"
    ...
    >
      <section>
        ...
        <p className="mb-3">
          東京のヘルス人気店について、初めての方にもわかりやすく解説します。このガイドでは東京の人気ヘルス店を厳選を中心に、必要な情報をまとめています。パネマジ掲示板の口コミと合わせて参考にしてください。
        </p>
      </section>
