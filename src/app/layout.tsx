...
export const metadata: Metadata = {
  // 2026-08: 嬢のパネル写真(外部ホットリンク)を全面停止したため、Referer潜脱用の
  //    no-referrer 設定は不要になり撤去。referrer はブラウザ既定に戻す。
  title: {
    default: "パネマジ掲示板｜風俗・ソープ・メンエスのパネル写真口コミ評価サイト",
    template: "%s｜パネマジ掲示板",
  },
  description:
    "パネマジ掲示板は、風俗嬢のパネル写真と実物が一致しているかを口コミでチェックできる風俗掲示板。全国47都道府県の風俗10,000店舗以上・37万人以上の女性を網羅し、デリヘル/ソープ/メンエス/ヘルスの口コミ・評判・パネマジ度をリアルタイム共有。",
  keywords: [
    "パネマジ",
    "パネマジ掲示板",
    "パネマジチェッカー",
  ...
  openGraph: {
    title: "パネマジ掲示板｜風俗・ソープ・メンエスのパネル写真口コミ評価サイト",
    description:
      "パネマジ掲示板 - パネル写真と実物の一致度を口コミでチェックできる風俗掲示板。全国10,000店舗以上・37万人以上の女性を網羅。",
    type: "website",
    locale: "ja_JP",
    siteName: "パネマジ掲示板",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                '風俗パネル写真と実物の一致度を口コミでチェックできるレビューサイト。全国47都道府県・10,000店舗以上を網羅。',
            }),
          }}
        />
