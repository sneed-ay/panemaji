...
export const metadata: Metadata = {
  ...
  description:
    "パネマジ掲示板は、風俗嬢のパネル写真と実物が一致しているかを口コミでチェックできる風俗掲示板。全国47都道府県の風俗18,000店舗以上・43万人以上の女性を網羅し、デリヘル/ソープ/メンエス/ヘルスの口コミ・評判・パネマジ度をリアルタイム共有。",
  keywords: [
    "パネマジ",
    "パネマジ掲示板",
    "パネマジチェッカー",
  ...
  openGraph: {
    ...
    description:
      "パネマジ掲示板 - パネル写真と実物の一致度を口コミでチェックできる風俗掲示板。全国18,000店舗以上・43万人以上の女性を網羅。",
    type: "website",
    locale: "ja_JP",
    siteName: "パネマジ掲示板",
