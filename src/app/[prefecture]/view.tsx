...
export function prefectureMetadata({ params }: { params: { prefecture: string } }): Metadata {
...
export function PrefectureView({ params, searchParams }: { params: { prefecture: string }; searchParams: { cat?: string } }) {
