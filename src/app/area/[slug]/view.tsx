...
export function areaMetadata({ params }: { params: { slug: string } }): Metadata {
...
export function AreaView({ params, searchParams }: { params: { slug: string }; searchParams: { cat?: string } }) {
  const area = getAreaBySlug(params.slug);
  if (!area) notFound();
